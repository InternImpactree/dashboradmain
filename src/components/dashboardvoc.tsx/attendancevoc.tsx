...
import { LiaChalkboardTeacherSolid, LiaGraduationCapSolid } from 'react-icons/lia';
  ...
  return (
    <>
      ...
      <AppBar position="static" sx={{ bgcolor: '#3485ae', boxShadow: 'none'}}>
          ...
          <Button component={Link} to="/attendancevoc"><b style={{color:"black",textTransform: "capitalize"}}>Attendance</b></Button>
...
{/* <div style={{ position: 'absolute', top: '50px', left: '10px', background: 'rgba(255, 255, 255, 0.9)', padding: '5px', borderRadius: '5px' }}>
      <p>  Average Attendance</p>
          ...
          <Doughnut
            data={{
              labels: classData.map((data: { label: string }) => data.label),
              datasets: [
                {
                  label: "Number",
                  data: classData.map((data: { value: number }) => data.value),
                  backgroundColor: [
                    "rgb(210, 69, 69)",
                    "rgb(55, 152, 67)",
