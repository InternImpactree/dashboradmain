 ...
 const layout = {
  yaxis: {
    tickfont: {
        ...
        size: 12, // Specify the font size for ticks
        color: "#747475" // Specify the font color for ticks
    }
},
...
const config = {
 ...
 <Chart style={{marginTop:'0px'}}
    ...
    <Col span={8}>
          <div className="dataCard" style={{marginLeft:'16px', marginRight:'0px', width:'340px'}}>
            <Pie
              className="chart-area"
              style={{ width: 300, height: 350}}
              data={{
        ...
        <div className="dataCard customerCard-mobilize" style={{marginLeft:' 17px', marginRight:'0px', width:'340px'}}>
          <Doughnut
